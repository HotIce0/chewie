...
#ifndef CONFIG_XINGTONG_PYBOARD_USBHOST_PRIO
#  define CONFIG_XINGTONG_PYBOARD_USBHOST_PRIO 100
#endif

#ifndef CONFIG_XINGTONG_PYBOARD_USBHOST_STACKSIZE
#  define CONFIG_XINGTONG_PYBOARD_USBHOST_STACKSIZE 1024
#endif
 ...
 *   GPIO pins for the xingtong-pyboard board.
 *
 ************************************************************************************/
  ...
  if (g_usbconn)
    {
      ...
      pid = kthread_create("usbhost", CONFIG_XINGTONG_PYBOARD_USBHOST_PRIO,
                        CONFIG_XINGTONG_PYBOARD_USBHOST_STACKSIZE,
